...
export default function MangaChapterSummary({ chapterId, onTopSummary, mode = "default" }: Props) {
      ...
      <div className="absolute bottom-2 right-2 z-20">
        <div className="relative">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md border border-neutral-700 bg-neutral-900 p-1.5 text-neutral-100 hover:bg-neutral-800"
          >
            <Icon className="h-4 w-4" />
          </button>

          {open && (
            <div className="absolute bottom-9 right-0 w-[360px] max-w-[80vw]">
              {ComposerPanel}
            </div>
          )}
        </div>
  ...
  return (
    <div className="mt-6 rounded-md border border-neutral-800 bg-black p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="text-sm font-semibold text-neutral-300">Chapter summary</h3>
          <p className="mt-1 text-xs text-neutral-500">
            Keep it high-level. No dialogue. No panel-by-panel.
          </p>
        </div>
