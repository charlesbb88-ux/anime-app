...
type Props = {
    ...
    /** Optional: pass the series poster in if you already have it. */
...
export default function AnimeEpisodeHeaderBackdrop({
    ...
    useEffect(() => {
        ...
        async function run() {
            ...
            // -------- resolve episode id (uuid or number) --------
            ...
            // -------- fetch series poster (fallback) if not provided --------
            if (!posterUrlProp) {
                ...
                if (aErr) {
                    console.error("AnimeEpisodeHeaderBackdrop: anime poster fetch error:", aErr);
                    setPosterUrl(null);
                } else {
    ...
    }, [animeId, episodeRefText, posterUrlProp]);
            ...
            {!resolved ? null : (
                <div className="episode-image-frame">
                    <SmartBackdropImage
                        ...
                        posterFallbackObjectPosition="50% 45%"   // ✅ ONLY the poster fallback moves
