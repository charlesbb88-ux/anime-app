            ...
            <div className="flex items-center justify-between gap-6">
                ...
                <nav className="flex gap-6 text-sm font-medium shrink-0">
                    ...
                    <Link
                        ...
                        className={`pb-2 ${router.asPath.startsWith(`${baseProfilePath}/anime`)
                                ? "border-b-2 border-slate-900 text-slate-900"
                                : "text-slate-500 hover:text-slate-800"
                            }`}
                    >
                    ...
                    <Link
                        ...
                        className={`pb-2 ${router.asPath.startsWith(`${baseProfilePath}/journal`)
                                ? "border-b-2 border-slate-900 text-slate-900"
                                : "text-slate-500 hover:text-slate-800"
                            }`}
                    >
                    ...
                    <Link
                        ...
                        className={`pb-2 ${router.asPath.startsWith(`${baseProfilePath}/library`)
                                ? "border-b-2 border-slate-900 text-slate-900"
                                : "text-slate-500 hover:text-slate-800"
                            }`}
                    >
