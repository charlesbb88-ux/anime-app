...
export default function ActionBoxMobile({
  onOpenLog,
  onShowActivity,
  ...
  const marksEnabled = targetKind === "anime" && Boolean(animeId);
    ...
    <AuthGate>
      <div
        className={[
          ...
          "w-full max-w-none",
          "overflow-hidden rounded-lg border border-gray-800 bg-[#000000] text-gray-200 shadow-sm",
        ].join(" ")}
      >
        {/* TOP ACTIONS */}
