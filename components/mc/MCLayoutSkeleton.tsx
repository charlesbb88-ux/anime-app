...
function SkeletonCard({
  ...
  return (
    <div className={`rounded-md border-2 border-black bg-white text-black ${className}`}>
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[320px_minmax(320px,1fr)_320px]">
          ...
          <div className="mt-2 space-y-2">
            ...
            <div className="rounded-2xl border border-black bg-white/20 px-4 py-2">
              ...
              <div className="mt-3 h-3 w-full overflow-hidden rounded-full border border-black bg-black/10">
                <div className="h-full w-[58%] rounded-full bg-black/20" />
              </div>
      ...
      <div className="order-1 flex flex-col gap-2 lg:order-none lg:col-start-2">
        <div className="h-full rounded-md border-2 border-black bg-white p-3 text-black">
          <div className="flex h-full flex-col">
            <div className="flex flex-1 items-start justify-center">
              <div className="flex w-full max-w-md flex-col items-center">
                <div className="relative w-full max-w-[420px]">
                  <div className="flex h-[420px] w-full items-center justify-center rounded-[2rem] border border-black bg-white/20">
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              ...
              >
                ...
                <div className="mt-3 h-2.5 w-full overflow-hidden rounded-full border border-black bg-black/10">
                  <div className="h-full w-[45%] rounded-full bg-black/20" />
                </div>
              </div>
            ))}
          </div>
