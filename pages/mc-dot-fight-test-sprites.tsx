...
const FIGHTER_LEFT = {
    idle: { src: "/mc/sprites/a/idle.png", frames: 6, fps: 8, loop: true },
    run: { src: "/mc/sprites/a/run.png", frames: 8, fps: 12, loop: true },
    jump: { src: "/mc/sprites/a/jump.png", frames: 4, fps: 10, loop: true },
    attack: { src: "/mc/sprites/a/attack.png", frames: 6, fps: 14, loop: false },
    hit: { src: "/mc/sprites/a/hit.png", frames: 3, fps: 12, loop: false },
    recover: { src: "/mc/sprites/a/recover.png", frames: 4, fps: 10, loop: false },
};

const FIGHTER_RIGHT = {
    idle: { src: "/mc/sprites/b/idle.png", frames: 6, fps: 8, loop: true },
    run: { src: "/mc/sprites/b/run.png", frames: 8, fps: 12, loop: true },
    jump: { src: "/mc/sprites/b/jump.png", frames: 4, fps: 10, loop: true },
    attack: { src: "/mc/sprites/b/attack.png", frames: 6, fps: 14, loop: false },
    hit: { src: "/mc/sprites/b/hit.png", frames: 3, fps: 12, loop: false },
    recover: { src: "/mc/sprites/b/recover.png", frames: 4, fps: 10, loop: false },
};
...
export default function McDotFightTestPage() {
    ...
    useEffect(() => {
        ...
        const fighterHalfWidth = 48;
        const fighterHeight = 96;
        ...
        const framedMaxY = bothAirborne
            ...
            : Math.max(
                fighterMaxY + CAMERA_AIR_BOTTOM_PADDING,
                GROUND_SCREEN_Y + CAMERA_BOTTOM_PADDING
            );
